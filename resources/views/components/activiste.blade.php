                ...
                <div class="card">
                    <div class="header">
                        ...
                        @else
                            ...
                            @elseif(access_order())
                                <h4 class="title text-center"><i class="fa fa-users text-info"></i> <span class="label label-info">Ajouter un Fournisseur</span></h4>

                            @elseif(access_sell())
                                <h4 class="title text-center"><i class="fa fa-users text-info"></i> <span class="label label-info">Ajouter un Client)</span></h4>
                            @endif
                        @endif
                    </div>
                    <div class="content">
...
@section('notification')
    ...
    @if(Session::has('supression-fournisseur'))
        <script type="text/javascript">
            notification('danger', 'Fournisseur suprimé');
        </script>
    @endif
    @if(Session::has('modification-fournisseur'))
        <script type="text/javascript">
            notification('success', 'Fournisseur modifié');
        </script>
    @endif
    @if(Session::has('supression-client'))
        <script type="text/javascript">
            notification('danger', 'Client suprimé');
        </script>
    @endif
